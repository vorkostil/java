...
public class TronGameFrame extends JFrame {
	...
	private TronGraphicalPanel gamePanel = null;
	private String login = null;
	private boolean isBlue = false;
	private DataRepository repository = new DataRepository();
	
	public TronGameFrame( GraphicalClient client, 
					  PrintWriter writer, 
					  String gameID, 
					  String name, 
					  String blue, 
					  String red ) throws IOException 
	{
		father = client;
		targetWriter  = writer;
		gameId  = gameID;
		...
		gamePanel = new TronGraphicalPanel( repository );
